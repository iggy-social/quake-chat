  ...
  <div class="card border scroll-500">
    <div class="card-body">
      ...
      <p class="text-break mt-3">
        Quake Chat is <strong>the first web3 social network</strong> built on Mantle.
      </p>
      ...
      <p class="text-break mt-3">
        Quake Chat is still in beta. This means that many features are still missing, but will be added over time. 
        There may also be bugs and other issues.
      </p>

      <p class="text-break mt-3">
        What we need from you at this point is to try out Quake Chat and provide us with feedback. 
        Feel free to post ideas, features suggestions, rants directly in the Quake Chat. 
        Or you can drop by 
